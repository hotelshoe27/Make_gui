...
root = Tk()
root.title("이미지 결합program ver 1.0")
# root.geometry("640x480+500+100") #가로 * 세로 + x좌표 + y좌표

# 파일 추가
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요.", \
        filetypes=(("PNG 파일","*.png"), ("모든 파일","*.*")), \
        initialdir=r"C:\Users\신태호\Desktop") # 바탕화면 경로
...
def merge_image():
    ...
    # y = height = size[1]
    # x' = img_width
    # y' = x'y/x = img_width * size[1] / sizde[0]  
